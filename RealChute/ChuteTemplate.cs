...
namespace RealChute
{
    public class ChuteTemplate
    {
        ...
        internal void UpdateCanopyTexture()
        {
            ...
            if (this.textures.TryGetCanopy(this.templateGUI.chuteID, ref canopy))
            {
        ...
        internal void UpdateCanopy()
        {
            ...
            {
                if (this.textures.TryGetModel(this.textures.modelNames[this.templateGUI.modelID], ref model))
                {
